...
class FightService(val heroService: HeroService) {
    ...
    private fun damagedStamina(hero1: Hero, hero2: Hero): Int {
        val stamina = hero1.stamina - generateDamage() * hero2.skill
    ...
    private fun fightWithResult(fight: Fight): Fight {
        ...
        val damagedHero1 = Hero(hero1.name, hero1.skill, damagedStamina(hero1, hero2))
        val damagedHero2 = Hero(hero2.name, hero2.skill, damagedStamina(hero2, hero1))
